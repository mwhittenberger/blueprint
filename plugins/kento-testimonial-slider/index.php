...
Plugin URI: http://kentothemes.com/demo/plugins/kento-testimonial-slider/
...
function KentoTestimonial_list(){
	...
	if (have_posts()) : while (have_posts()) : the_post(); 
		...
		$KentoTestimonial.='<li><div class="kento-testimonial-author-comments">'.$content.'</div><div class="kento-testimonial-author"><img class="kento-testimonial-author-img" width="150px" height="150px" src="'.$url.'" /><p class="kento-testimonial-author-name">'.$author.'</p></div></li>';
